...
//   }
const totalPriceCal = cart.reduce((total, item)=>{
  return total + item.count * item.price;
}, 0 ).toFixed(2);

// const tax = cart.reduce(subTotalPrice=>{
//   return subTotalPrice*1.13;
// }, 0 ).toFixed(2);

// const totalPrice = cart.reduce((subTotalPrice, tax)=>{
//   return subTotalPrice+t;
// }, 0 ).toFixed(2);
