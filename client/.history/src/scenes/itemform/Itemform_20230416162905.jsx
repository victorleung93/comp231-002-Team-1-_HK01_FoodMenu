 ...
 const fetchData = async () => {
  ...
  return (
    <div className="App"  style={{width:"80%", margin:"80px auto"}}>
      ...
      <select name="available" value={formData.available} onChange={handleCategoryChange}>
        <option value='available'>newArrivals</option>
        <option value='notAvailable'>bestSellerss</option>
        <option value='topRted'>topRated</option>
      </select><br></br>
