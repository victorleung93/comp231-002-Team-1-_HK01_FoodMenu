...
const Itemform = () =>{
 ...
 const fetchData = async () => {
  ...
  With this code, the input field will be pre-filled with the existing value when available, but still allow the user to choose from the available options in the datalist.
  ...
  async function getItem(itemId) {
   ...
   setItem(item.data);
    ...
    formData.name=item.data.name;
    formData.shortDescription=item.data.shortDescription;
    formData.longDescription=item.data.longDescription;
    formData.price=item.data.price;
  ...
  return (
    <div className="App"  style={{width:"80%", margin:"80px auto"}}>
      ...
      <input type="text" name="category" value={existingCategory || formData.category} onChange={handleChange} list="categoryOptions"/>
