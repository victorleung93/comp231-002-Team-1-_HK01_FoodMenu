    ...
    const onChange = (e) => {
      ...
      const onSubmit = async (e) => {
        e.preventDefault();
         ...
         console.log(b64file);
    await axios.post(urlForServer + "upload", { image: b64file });
    fetchData();
    setPreview(null);
  };
 ...
 const fetchData = async () => {
  ...
  return (
    <div className="App"  style={{width:"80%", margin:"80px auto"}}>
      ...
      <input type="text" name="name" value={formData.longDescription} onChange={handleChange} placeholder="Long Description"/><br></br>
      <input type="text" name="" value={formData.longDescription} onChange={handleChange} placeholder="Long Description"/><br></br>
      <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Name"/><br></br>
      <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Name"/><br></br>
