...
const ItemDetails = () =>{
    ...
    async function getItem() {
        ...
        //   { method: "GET" }
        // );
        let items = await axios.get(urlForServer + "data/"+ itemId);
        // const itemsJson = await items.json();
        dispatch(setItem(items.data));
      }
        ...
        <div style={{width:"80%", margin:"80px auto"}}>
            ...
            <div style={{display:"flex", flexWrap:"wrap", columnGap:"40px"}}>
                <div style={{flex:"1 1 40%", marginBottom:"40px" }}>
                    {/*Image*/}
                    <img src={item[1].image} style={{objectFit : "contain" , width:"500px", height:"600px"}} alt={item?.name}  />
                </div>
