            ...
            <div style={{display:"flex", flexWrap:"wrap", columnGap:"40px"}}>
                ...
                <div style={{flex:"1 1 50%", marginBottom:"40px" }}>
                    ...
                    <div style={{margin:"65px 0 25px 0"}}>
                        <Typography sx={{mb:"20px"}} variant="h3">{item?.name}</Typography>
                    ...
                    <div style={{margin:"30px 0"}}>
                        <Typography variant="h4">Categories: {item?.category.replace(/([A-Z])/g, " $1").replace(/^./, (str)=> str.toUpperCase("\ "))}</Typography>
                    </div>
